...
This repository documents my journey learning Amazon Web Services (AWS). Here you will find practical labs, architecture diagrams, and implementation notes.

## 📂 Project Portfolio

| Project Name | Description | Status |
| :--- | :--- | :--- |
| **[Amazon Bedrock Guardrails](./bedrock-guardrails)** | Implementing content filters and denied topics for Generative AI. | ✅ Completed |
